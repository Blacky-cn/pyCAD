...
class OOP(object):
    ...
    def page_pendulum(self):
        ...
        # Add a Label_摆杆间距
        ttk.Label(pendulum_frame2, text='摆杆间距(mm): ').grid(column=0, row=1)
        ...
        # Add a Label_工件数量
        l_num = ttk.Label(pendulum_frame2, text='工件数量: ')
        l_num.grid(column=0, row=5)
        # Add an Entry_工件数量
        self.carnum = tk.IntVar()
        e_num = ttk.Entry(pendulum_frame2, width=12, textvariable=self.carnum)
