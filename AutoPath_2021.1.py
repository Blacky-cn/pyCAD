...
class OOP(object):
    ...
    def create_widgets(self):
        ...
        for cartype, cartype_num in cartypes.items():
            self.a_cartype = ttk.Radiobutton(self.tab1_frame1, text=cartype, value=cartype_num,
    ...
    def choose_pathtype(self):
        ...
        for pathtype, pathtype_num in pathtypes.items():
            self.a_pathtype = ttk.Radiobutton(self.tab1_frame2, text=pathtype, value=pathtype_num,
                                              variable=self.pathtype_value, command=self.callbacks.nexten)
